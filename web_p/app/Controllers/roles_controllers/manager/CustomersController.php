...
class CustomersController extends CodeIgniterBaseController
{
    ...
    public function index()
    {
        ...
        echo view('template/header', header_data(1, $session_data))
            . view('roles_view/manager/customers', $session_data);
    }
    ...
    public function load_upd_view($id)
    {
        ...
        $res_data['customer'] = $customerModel->get_one($id);

        echo view('roles_view/manager/customers_upd', $res_data);
    }
    ...
    public function update_customer()
    {
        ...
        if (!$validation->run($data, 'customer')) {
            ...
            $customerModel->update_customer($id, $first_name, $middle_name, $last_name, $phone_number, $pseudonym);
