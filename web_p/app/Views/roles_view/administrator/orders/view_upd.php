...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color: #f48412;">
        <div class="container-fluid">
            <div>
                <a href="<?= base_url('administrator/orders/view') ?>"><img src="/img/back.png" alt="UPD" width="50" height="50"></a>
            </div>
                    ...
                    <tbody id="t_body">
                        <?php foreach ($tasks as $task) : ?>
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-danger" style="background-color: #F41812; border-color:#F41812;" onclick="window.delete_task(<?= $task->id ?>)"><img src="/img/trash.png" alt="Logo" width="20" height="20"></button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
    ...
    <script>
        window.addEventListener('DOMContentLoaded', () => {
            ...
            paymentCheck.addEventListener('change', () => {
                ...
                xhr.open('POST', '/administrator/orders/view/update_order', true);
            ...
            window.delete_task = function(id) {
                ...
                xhr.open('POST', '/administrator/orders/view/delete_task', true);
                xhr.setRequestHeader('Content-Type', 'application/json');
