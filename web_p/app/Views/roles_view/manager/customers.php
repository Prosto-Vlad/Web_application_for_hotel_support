        ...
        <div class="d-flex" style="padding: 0;">
            ...
            <div class="ms-auto p-2">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal_add_cust" style="background-color: #f48412; border-color:#f48412;">
                    <img src="/img/add.png" alt="Register" width="20" height="20">
                </button>
...
<!-- TODO: видалення користувача (чистка інформації) -->
<script>
    window.addEventListener('DOMContentLoaded', () => {
        ...
        add_cust_btn.addEventListener('click', () => {
            ...
            xhr.open('POST', '<?= base_url('manager/customers/add') ?>', true);
        ...
        function search() {
            let xhr = new XMLHttpRequest();
            xhr.open('POST', '<?= base_url('manager/customers/search') ?>', true);
            xhr.setRequestHeader('X-Requested-With', 'XMLHttpRequest');
            xhr.setRequestHeader('Content-Type', 'application/json');
                ...
                if (xhr.status == 200) {
                    ...
                    for (let i = 0; i < search_results.length; i++) {
                        ...
                        tr.innerHTML = '<th>' + search_results[i].last_name + ' ' + search_results[i].first_name + ' ' + search_results[i].middle_name + '</th>' +
                            ...
                            '<td><a style="background-color: #f48412; border-color:#f48412;" class="btn btn-primary"  href="' + '<?= base_url('manager/customers/update/') ?>' + search_results[i].id + '"><img src="/img/edit.png" alt="UPD" width="25" height="25"></a></td>';
