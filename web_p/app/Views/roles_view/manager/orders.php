<div class="container mt-4">
    <div class="row">
        ...
        <div class="col-12 col-md-2">
            ...
            <input type="date" class="form-control mt-3" id="create_date" name="create_date">
        </div>
...
<script>
    window.addEventListener('DOMContentLoaded', () => {
        ...
        function search_order() {
            ...
            xhr.open('POST', '<?= base_url('manager/orders/search') ?>');
                ...
                if (xhr.status != 200) {
                    ...
                    for (let i = 0; i < res_data.length; i++) {
                        if (res_data[i].is_finish != 't') {
                            ...
                            tr.innerHTML += '<th><a style="background-color: #f48412; border-color:#f48412;" class="btn btn-primary" href="<?= base_url('manager/orders/update') ?>/' + res_data[i].id + '" class="btn btn-primary"><img src="/img/more.png" alt="Register" width="20" height="20"></a></th>';
